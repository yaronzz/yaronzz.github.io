  ...
  _createClass(Algolia, [{
    ...
    value: function render() {
      ...
      if (!applicationId || !apiKey || !indexName) {
        return (0, _inferno.createVNode)(1, "div", "notification is-danger", [(0, _inferno.createTextVNode)("It seems that you forget to set the "), (0, _inferno.createVNode)(1, "code", null, "applicationId", 16), (0, _inferno.createTextVNode)(", "), (0, _inferno.createVNode)(1, "code", null, "apiKey", 16), (0, _inferno.createTextVNode)(", or "), (0, _inferno.createVNode)(1, "code", null, "indexName", 16), (0, _inferno.createTextVNode)(" for the Aloglia. Please set it in "), (0, _inferno.createVNode)(1, "code", null, "_config.yml", 16), (0, _inferno.createTextVNode)(".")], 4);
      }

      var js = "document.addEventListener('DOMContentLoaded', function () {\n            loadAlgolia(".concat(JSON.stringify({
      ...
      return (0, _inferno.createFragment)([(0, _inferno.createVNode)(1, "div", "searchbox", (0, _inferno.createVNode)(1, "div", "searchbox-container", [(0, _inferno.createVNode)(1, "div", "searchbox-header", [(0, _inferno.createVNode)(1, "div", "searchbox-input-container", null, 1, {
        "id": "algolia-input"
      }), (0, _inferno.createVNode)(1, "div", "is-flex", null, 1, {
        "id": "algolia-poweredby",
        "style": "margin:0 .5em 0 1em;align-items:center;line-height:0"
